...
let seatle = graph.createVertex(data: "Seatle")
...
graph.add(.undirected, from: washingtonDC, to: seatle, weight: 277)
graph.add(.undirected, from: sanFrancisco, to: seatle, weight: 218)
